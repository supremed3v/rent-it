  ...
  const getSellerDetails = React.useCallback(async () => {
    try {
      const { data } = await axios.get(
        `http://localhost:5000/api/v1/seller-details/${product.seller}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  return (
    ...
    >
              ...
              >
                ...
                >
                  <Typography
                    ...
                    component="h2"
                  >
                    {product?.isApproved ? "Change availiblity status" : "Approve Product"}
                  </Typography>
      ...
      >
        ...
        {sellerDetails && (
          <Box>
            <Typography variant="h6">Name: {sellerDetails?.name}</Typography>
            <Typography variant="h6">Email: {sellerDetails?.email}</Typography>
            <Typography variant="h6">
